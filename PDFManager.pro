...
CONFIG += c++11 dynamic # add static if you built mupdf library statically (default behavior of the mupdf provided MSVC project)
...
win32 {
    ...
    INCLUDEPATH += $$MUPDFPATH\include
    LIBS += -L$$MUPDFPATH\build\release
